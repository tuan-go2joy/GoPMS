...
function useQueryProvider(arg1, id) {
    if (arg1 === void 0) { arg1 = {}; }
    if (id === void 0) { id = ""; }
    var client = arg1 instanceof core.QueryClient ? arg1 : new core.QueryClient(arg1);
    client.mount();
    var key = getClientKey(id);
...
var VueQueryPlugin = {
    install: function (app, options) {
        ...
        if ("queryClient" in options && options.queryClient) {
            ...
            client = new core.QueryClient(clientConfig);
        }
        client.mount();
...
function useQueries(queries) {
    var _a;
    var queryClientKey = (_a = vueDemi.unref(queries)[0]) === null || _a === void 0 ? void 0 : _a.queryClientKey;
    var queryClient = useQueryClient(queryClientKey);
    var defaultedQueries = vueDemi.unref(queries).map(function (options) {
    ...
    if (vueDemi.isRef(queries) || vueDemi.isReactive(queries)) {
        vueDemi.watch(queries, function () {
            var defaulted = vueDemi.unref(queries).map(function (options) {
                return queryClient.defaultQueryObserverOptions(options);
            });
...
Object.defineProperty(exports, 'MutationCache', {
    enumerable: true,
    get: function () { return core.MutationCache; }
});
...
Object.defineProperty(exports, 'QueryCache', {
    enumerable: true,
    get: function () { return core.QueryCache; }
});
Object.defineProperty(exports, 'QueryClient', {
    enumerable: true,
    get: function () { return core.QueryClient; }
});
